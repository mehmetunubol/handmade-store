...
import com.unubol.demo.store.config.audit.AuditEventConverter;
import com.unubol.demo.store.domain.PersistentAuditEvent;
...
import static com.unubol.demo.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
