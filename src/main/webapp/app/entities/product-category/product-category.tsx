                ...
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {productCategory.image ? (
                      <div>
                        {productCategory.imageContentType ? (
                          <a onClick={openFile(productCategory.imageContentType, productCategory.image)}>
                            <img
                              src={`data:${productCategory.imageContentType};base64,${productCategory.image}`}
                        ...
                        <span>
                          {productCategory.imageContentType}, {byteSize(productCategory.image)}
                        </span>
                      </div>
                    ) : null}
                  </td>
